...
public class Loginnn {
 ...
 private void initialize() {
  ...
  frameLoginForm.setVisible(true);
   ...
   URL url = Loginnn.class.getResource("/Image/icondangnhap.png");
...
//  lblUserName.setIcon(new javax.swing.ImageIcon(Login.class.getResource("/image/user.png")));
  ...
  btnLogin.setIcon(new ImageIcon(Loginnn.class.getResource("/image/cn2.png")));
